...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog Pessoal - Thana Rodrigues")
	...
	private static Contact contact() {
		return new Contact("Thanailde Rodrigues", "https://github.com/strangerthana", "thanailde.oliveira@outlook.com");
	}
